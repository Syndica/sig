...
const elgamal = runtime.zksdk.elgamal;
const pedersen = runtime.zksdk.pedersen;
const ElGamalKeypair = runtime.zksdk.ElGamalKeypair;
const ElGamalPubkey = runtime.zksdk.ElGamalPubkey;
const Ristretto255 = std.crypto.ecc.Ristretto255;
const Scalar = std.crypto.ecc.Edwards25519.scalar.Scalar;
const Transcript = runtime.zksdk.Transcript;
const ed25519 = sig.crypto.ed25519;
const GroupedElGamalCiphertext = elgamal.GroupedElGamalCiphertext(2);
const ProofType = runtime.program.zk_elgamal.ProofType;

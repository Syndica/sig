...
const GroupedElGamalCiphertext = runtime.zksdk.GroupedElGamalCiphertext(3);
...
pub const Data = struct {
    ...
    const DOMAIN: DomainSeperator = .@"grouped-ciphertext-validity-3-handles-instruction";
...
pub const BatchedData = struct {
    ...
    const DOMAIN: DomainSeperator = .@"batched-grouped-ciphertext-validity-3-handles-instruction";

...
/// [agave] https://github.com/solana-program/system/blob/6185b40/interface/src/instruction.rs#L64
pub const NONCE_STATE_SIZE: u64 = 80;

/// [agave] https://github.com/solana-program/system/blob/6185b40/interface/src/lib.rs#L18
pub const MAX_PERMITTED_DATA_LENGTH: u64 = 10 * 1024 * 1024;

/// [agave] https://github.com/solana-program/system/blob/6185b40/interface/src/lib.rs#L26
pub const MAX_PERMITTED_ACCOUNTS_DATA_ALLOCATIONS_PER_TRANSACTION: i64 = 2 * 10 * 1024 * 1024;

/// [agave] https://github.com/solana-program/system/blob/6185b40/interface/src/lib.rs#L30
...
// https://github.com/anza-xyz/agave/blob/9e7637a/sdk/program/src/system_instruction.rs#L885
pub fn transfer(
...
// https://github.com/anza-xyz/agave/blob/9e7637a/sdk/program/src/system_instruction.rs#L1105
pub fn allocate(
    allocator: std.mem.Allocator,
    pubkey: Pubkey,
    space: u64,
...
// https://github.com/anza-xyz/agave/blob/9e7637a/sdk/program/src/system_instruction.rs#L674
pub fn assign(
    allocator: std.mem.Allocator,
    pubkey: Pubkey,
    owner: Pubkey,

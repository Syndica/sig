...
const syscalls = runtime.vm.syscalls;
const executor = runtime.executor;

const InstructionInfo = runtime.InstructionInfo;
const elf = runtime.vm.elf;
const Executable = runtime.vm.Executable;
const Config = runtime.vm.Config;
const Region = runtime.vm.memory.Region;
const MemoryMap = runtime.vm.memory.MemoryMap;
const Vm = runtime.vm.interpreter.Vm;
const VmResult = runtime.vm.interpreter.Result;
const OpCode = sbpf.Instruction.OpCode;
const SyscallMap = runtime.vm.SyscallMap;
const Syscall = runtime.vm.syscalls.Syscall;

const expectEqual = std.testing.expectEqual;
const createTransactionContext = runtime.testing.createTransactionContext;
const deinitTranactionContext = runtime.testing.deinitTransactionContext;
...
test "pqr" {
    ...
    inline for (
        ...
        var registry: runtime.vm.Registry = .{};
        var loader: SyscallMap = .ALL_DISABLED;
...
test "BPF_64_64 sbpfv0" {
    ...
    // returns the address of the first byte in the .text section
    try testElf(
        .{ .maximum_version = .v0 },
...
fn testVerifyTextBytesWithSyscalls(
    ...
    var function_registry: runtime.vm.Registry = .{};
    var executable = try Executable.fromTextBytes(
        allocator,
        program,
        &loader,
...
test "jump to middle of lddw" {
    try testVerify(.{ .maximum_version = .v0 },
        \\entrypoint:
        \\  ja +1
        \\  lddw r0, 0x1122334455667788
        \\  exit
...
pub fn testSyscall(
    ...
    config: struct {
        ...
        feature_set: []const runtime.testing.ExecuteContextsParams.FeatureParams = &.{},
    },
) !void {

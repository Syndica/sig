...
const VOTE_PROGRAM_COMPUTE_UNITS: u64 = 2_100;
const ED25519_PRECOMPILE_ID: sig.core.Pubkey = .parse("Ed25519SigVerify111111111111111111111111111");
const SECP256K1_PRECOMPILE_ID: sig.core.Pubkey = .parse("KeccakSecp256k11111111111111111111111111111");
const SECP256R1_PRECOMPILE_ID: sig.core.Pubkey = .parse("Secp256r1SigVerify1111111111111111111111111");
const SECP256K1_VERIFY_COST: u64 = COMPUTE_UNIT_TO_US_RATIO * 223;
const ED25519_VERIFY_COST: u64 = COMPUTE_UNIT_TO_US_RATIO * 76;
const ED25519_VERIFY_STRICT_COST: u64 = COMPUTE_UNIT_TO_US_RATIO * 80;
const SECP256R1_VERIFY_COST: u64 = COMPUTE_UNIT_TO_US_RATIO * 160;
...
pub const SIMPLE_VOTE_USAGE_COST: u64 = VOTE_PROGRAM_COMPUTE_UNITS +
    SIGNATURE_COST +
    2 * WRITE_LOCK_UNITS +
...
pub const TransactionCost = union(enum) {
    ...
    pub fn programsExecutionCost(self: TransactionCost) u64 {
        return switch (self) {
            .simple_vote => VOTE_PROGRAM_COMPUTE_UNITS,
...
test "runtime.cost_model.TransactionCost.programsExecutionCost for simple_vote" {
    ...
    try std.testing.expectEqual(
        @as(u64, VOTE_PROGRAM_COMPUTE_UNITS),

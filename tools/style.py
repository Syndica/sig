...
files_excluded_from_line_length_check = [
    # src
    "v2/components/runtime/bincode/arraylist.zig",
    "v2/components/runtime/bincode/bincode.zig",
    "v2/components/runtime/bincode/int.zig",
    "v2/components/runtime/bincode/shortvec.zig",
    "v1/src/bloom/bitvec.zig",
    "v2/components/runtime/bloom/bit_set.zig",
    "v2/components/runtime/bloom/bit_vec.zig",
    "v1/src/core/leader_schedule.zig",
    "v2/components/runtime/core/transaction.zig",
    "v1/src/gossip/data.zig",
    "v1/src/gossip/fuzz_service.zig",
    "v1/src/gossip/fuzz_table.zig",
    "v1/src/gossip/message.zig",
    "v1/src/gossip/ping_pong.zig",
    "v1/src/gossip/pull_request.zig",
    "v1/src/gossip/service.zig",
    "v1/src/gossip/shards.zig",
    "v1/src/ledger/cleanup_service.zig",
    "v1/src/ledger/database/hashmap.zig",
    "v1/src/ledger/database/rocksdb.zig",
    "v1/src/ledger/reed_solomon_table.zig",
    "v1/src/ledger/reed_solomon.zig",
    "v1/src/ledger/shred_inserter/working_state.zig",
    "v1/src/ledger/shred.zig",
    "v1/src/ledger/test_shreds.zig",
    "v1/src/rpc/client.zig",
    "v1/src/rpc/request.zig",
    "v1/src/rpc/test_serialize.zig",
    "v1/src/shred_network/collector/repair_message.zig",
    "v1/src/shred_network/collector/repair_service.zig",
    "v1/src/sync/thread_pool.zig",
    "v1/src/transaction_sender/service.zig",
    "v2/components/shred/api.zig",
    "v2/components/shred/reed_solomon_table.zig",

    # Generated files, will not conform to style guide.
    "v2/components/runtime/crypto/bn254/bn254_64.zig",
    "v2/components/runtime/crypto/ed25519/wycheproof.zig",

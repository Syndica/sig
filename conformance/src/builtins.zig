...
const STAKE_PROGRAM: Pubkey = .parse("8t3vv6v99tQA6Gp7fVdsBH66hQMaswH5qsJVqJqo8xvG");
const CONFIG_PROGRAM: Pubkey = .parse("BuafH9fBv62u6XjzrzS4ZjAE8963ejqF5rt1f8Uga4Q3");
const ADDRESS_LOOKUP_TABLE: Pubkey = .parse("AhXWrD9BBUYcKjtpA3zuiiZG4ysbo6C6wjHo1QhERk6A");
const FEATURE_PROGRAM: Pubkey = .parse("3D3ydPWvmEszrSjrickCtnyRSJm1rzbbSsZog8Ub6vLh");
...
pub const BUILTINS = [_]BuiltinProgram{
    ...
    .{
        ...
        .core_bpf_migration_config = .{
            .program_id = program.stake.ID,
            .source_buffer_address = STAKE_PROGRAM,
    ...
    .{
        ...
        .core_bpf_migration_config = .{
            .program_id = program.config.ID,
            .source_buffer_address = CONFIG_PROGRAM,
            .upgrade_authority_address = null,
    ...
    .{
        ...
        .core_bpf_migration_config = .{
            .program_id = program.address_lookup_table.ID,
            .source_buffer_address = ADDRESS_LOOKUP_TABLE,
            .upgrade_authority_address = null,
...
pub const STATELESS_BUILTINS = [_]StatelessBuiltinPrototype{
    .{
        ...
        .core_bpf_migration_config = .{
            .program_id = sig.runtime.ids.FEATURE_PROGRAM_ID,
            .source_buffer_address = FEATURE_PROGRAM,
            .upgrade_authority_address = null,

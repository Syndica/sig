...
pub const Activity = extern struct {
    ...
    pub const ServiceView = struct {
        ...
        /// consecutively before a signal is actually emitted. See the
        /// doc comment on `Activity.signalIdle` for further commentary
        /// on what it means to be "idle".
    ...
    // TODO: evaluate whether it makes sense to also require "The
    // service has no outgoing values present in its outputs."

...
pub const bpf = struct {
    ...
    pub fn printSleepExit(maybe_stderr: ?std.os.linux.fd_t) [80]sock_filter {
        // load syscall number
        ...
        return preamble ++
            ...
            allowSyscall(@intFromEnum(syscalls.madvise)) ++
            allowSyscall(@intFromEnum(syscalls.gettid)) ++ // TODO: remove

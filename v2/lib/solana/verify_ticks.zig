...
/// Errors a block may fail with during validation. Matches
/// agave's `BlockError`; not every variant is produced by `verifyTicks`
/// (the rest are reserved for higher-layer validation).
///

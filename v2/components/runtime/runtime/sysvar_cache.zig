...
pub const SysvarCache = struct {
    ...
    pub fn get(
        ...
        // EpochRewards, Rent, LastRestartSlot, and Fees have comptime known sizes. SlotHashes,
        // StakeHistory, and RecentBlockhashes are allocated on insertion to the sysvar cache.

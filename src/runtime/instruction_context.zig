...
pub const InstructionContext = struct {
    ...
    /// TODO: Is Transaction.MAX_ACCOUNTS the correct upper bound?
    ...
    pub fn borrowInstructionAccount(
        ...
        const instr_account_meta = self.getAccountMetaAtIndex(index_in_instruction) orelse
            return InstructionError.NotEnoughAccountKeys;
    ...
    pub fn getSysvarWithAccountCheck(
        ...
        const instr_account_meta = self.getAccountMetaAtIndex(index_in_instruction) orelse
            return InstructionError.NotEnoughAccountKeys;
        if (!T.ID.equals(&instr_account_meta.pubkey)) return InstructionError.InvalidArgument;

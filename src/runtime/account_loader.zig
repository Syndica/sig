...
const shared_account_loader = shared.runtime.account_loader;
...
pub const MAX_TX_ACCOUNT_LOCKS = shared_account_loader.MAX_TX_ACCOUNT_LOCKS;
pub const TRANSACTION_ACCOUNT_BASE_SIZE = shared_account_loader.TRANSACTION_ACCOUNT_BASE_SIZE;
pub const ADDRESS_LOOKUP_TABLE_BASE_SIZE = shared_account_loader.ADDRESS_LOOKUP_TABLE_BASE_SIZE;
pub const RentDebit = shared_account_loader.RentDebit;
pub const LoadedTransactionAccounts = shared_account_loader.LoadedTransactionAccounts;
pub const LoadedAccount = shared_account_loader.LoadedAccount;
pub const PreparedAccount = shared_account_loader.PreparedAccount;
...
pub const collectRentFromAccount = shared_account_loader.collectRentFromAccount;

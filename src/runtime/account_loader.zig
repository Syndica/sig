...
pub const MAX_TX_ACCOUNT_LOCKS = shared.runtime.loaded_accounts.MAX_TX_ACCOUNT_LOCKS;
...
pub const RentDebit = shared.runtime.loaded_accounts.RentDebit;
...
pub const LoadedTransactionAccounts = shared.runtime.loaded_accounts.LoadedTransactionAccounts;

// An account that was loaded to execute a transaction. The data slice is owned.
pub const LoadedAccount = shared.runtime.loaded_accounts.LoadedAccount;
...
pub const AccountLoadError = shared.runtime.loaded_accounts.AccountLoadError;

/// Wraps calls to AccountsDB and convert all errors except OutOfMemory into AccountsDBError.
pub const wrapDB = shared.runtime.loaded_accounts.wrapDB;

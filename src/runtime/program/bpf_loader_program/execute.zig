...
pub fn executeV3Write(
    ...
    const buffer_account_index = 0;
    const buffer_authority_index = 1;
    const buffer_authority_meta = ic.info.account_metas.buffer[buffer_authority_index];
...
pub fn executeV3DeployWithMaxDataLen(
    ...
    const derived_key, const bump_seed = pubkey_utils.findProgramAddress(
        ...
        ic.tc.custom_error = 10102; // TODO: Place holder error, agave panics here
    ...
    const account_metas = &.{
        ...
        .{
            .pubkey = ic.info.account_metas.buffer[buffer_index].pubkey,
            .is_signer = false,
            .is_writable = true,
        },
    };
    ...
    // https://github.com/anza-xyz/agave/blob/c5ed1663a1218e9e088e30c81677bc88059cc62b/programs/bpf_loader/src/lib.rs#L704-L726
    {
        ...
        try program_data_account.serializeIntoAccountData(

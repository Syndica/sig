...
pub fn intFromInstructionErrorEnum(err: InstructionErrorEnum) u32 {
    switch (err) {
        .GenericError => return 1,
        .InvalidArgument => return 2,
        .InvalidInstructionData => return 3,
        .InvalidAccountData => return 4,
        .AccountDataTooSmall => return 5,
        .InsufficientFunds => return 6,
        .IncorrectProgramId => return 7,
        .MissingRequiredSignature => return 8,
        .AccountAlreadyInitialized => return 9,
        .UninitializedAccount => return 10,
        .UnbalancedInstruction => return 11,
        .ModifiedProgramId => return 12,
        .ExternalAccountLamportSpend => return 13,
        .ExternalAccountDataModified => return 14,
        .ReadonlyLamportChange => return 15,
        .ReadonlyDataModified => return 16,
        .DuplicateAccountIndex => return 17,
        .ExecutableModified => return 18,
        .RentEpochModified => return 19,
        .NotEnoughAccountKeys => return 20,
        .AccountDataSizeChanged => return 21,
        .AccountNotExecutable => return 22,
        .AccountBorrowFailed => return 23,
        .AccountBorrowOutstanding => return 24,
        .DuplicateAccountOutOfSync => return 25,
        .Custom => |_| return 26,
        .InvalidError => return 27,
        .ExecutableDataModified => return 28,
        .ExecutableLamportChange => return 29,
        .ExecutableAccountNotRentExempt => return 30,
        .UnsupportedProgramId => return 31,
        .CallDepth => return 32,
        .MissingAccount => return 33,
        .ReentrancyNotAllowed => return 34,
        .MaxSeedLengthExceeded => return 35,
        .InvalidSeeds => return 36,
        .InvalidRealloc => return 37,
        .ComputationalBudgetExceeded => return 38,
        .PrivilegeEscalation => return 39,
        .ProgramEnvironmentSetupFailure => return 40,
        .ProgramFailedToComplete => return 41,
        .ProgramFailedToCompile => return 42,
        .Immutable => return 43,
        .IncorrectAuthority => return 44,
        .BorshIoError => |_| return 45,
        .AccountNotRentExempt => return 46,
        .InvalidAccountOwner => return 47,
        .ProgramArithmeticOverflow => return 48,
        .UnsupportedSysvar => return 49,
        .IllegalOwner => return 50,
        .MaxAccountsDataAllocationsExceeded => return 51,
        .MaxAccountsExceeded => return 52,
        .MaxInstructionTraceLengthExceeded => return 53,
        .BuiltinProgramsMustConsumeComputeUnits => return 54,
    }
}

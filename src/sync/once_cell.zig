...
pub fn OnceCell(comptime T: type) type {
    return struct {
        ...
        /// Tries to initialize the inner value and returns pointer to it, or return error if it
        /// fails.
        /// Returns error if it was already initialized.
        /// Blocks while other threads are in the process of initialization.
        ...
        /// - waits if another thread has a write in progress. if the other thread fails, this may
        /// acquire the lock.

...
pub fn syscalls(Context: type) type {
    return struct {
        ...
        pub fn log(ctx: *Context, mmap: *MemoryMap, registers: RegisterMap) Error!void {
        ...
        pub fn log64(ctx: *Context, _: *MemoryMap, registers: RegisterMap) Error!void {
        ...
        pub fn logPubkey(ctx: *Context, mmap: *MemoryMap, registers: RegisterMap) Error!void {
        ...
        pub fn logComputeUnits(ctx: *Context, _: *MemoryMap, _: RegisterMap) Error!void {
        ...
        pub fn memset(ctx: *Context, mmap: *MemoryMap, registers: RegisterMap) Error!void {
        ...
        pub fn memcpy(ctx: *Context, mmap: *MemoryMap, registers: RegisterMap) Error!void {
            const dst_addr = registers.get(.r1);
        ...
        pub fn memcmp(ctx: *Context, mmap: *MemoryMap, registers: RegisterMap) Error!void {
        ...
        pub fn poseidon(ctx: *Context, mmap: *MemoryMap, registers: RegisterMap) Error!void {
        ...
        // special
        pub fn abort(_: *Context, _: *MemoryMap, _: RegisterMap) Error!void {
            return error.SyscallAbort;
        }

        pub fn panic(ctx: *Context, mmap: *MemoryMap, registers: RegisterMap) Error!void {

...
pub fn readCtx(
    ...
    /// * fn readKey(allocator: std.mem.Allocator, reader: anytype, params: bincode.Params) !Key
    ///   or `pub const readKey = {}`.
    /// * fn freeKey(allocator: std.mem.Allocator, key: Key) void`, or `pub const freeKey = {}
    /// * fn readValue(allocator: std.mem.Allocator, reader: anytype, params: bincode.Params) !Value
    ///   or `pub const readValue = {}`.
    /// * fn freeValue(allocator: std.mem.Allocator, value: Value) void
    ///   or `pub const freeValue = {}`.
    ///

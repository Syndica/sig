...
fn activationStateFromAccount(owner: Pubkey, data: []const u8) !FeatureActivationState {
    if (data.len < 9 or !owner.equals(&sig.runtime.ids.FEATURE_PROGRAM_ID)) return .invalid;

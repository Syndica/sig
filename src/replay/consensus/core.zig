...
test "processResult and handleDuplicateConfirmedFork" {
    ...
    var consensus: TowerConsensus = try .init(allocator, .{
        ...
        .vote_identity = replay_state.my_identity,
...
test "edge cases - duplicate slot" {
    ...
    const slot1_hash: Hash = .initRandom(prng);
    {
        ...
        var slot_state: sig.core.SlotState = try .genesis(gpa);
    ...
    try sig.replay.service.runConsensus(gpa, .FOR_TESTS, .{
        ...
        .slot_results = &replay_slot_results,
    });
...
test "edge cases - gossip verified vote hashes" {
    ...
    var verified_vote_channel: sig.sync.Channel(VerifiedVote) = try .init(gpa);
    ...
    try sig.replay.service.runConsensus(gpa, .FOR_TESTS, .{
        ...
        .vote_collection = .{
            ...
            .gossip_table = null,
            .verified_vote_channel_sender = &verified_vote_channel,
        },

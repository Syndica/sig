...
pub fn main() !void {
    ...
    // const BenchmarkFnc = struct { type, []const u8 };
    ...
    //                 const bench = @field(@field(lib, decl.name), pkg_decl.name);
    //                 benchmark_fcns = benchmark_fcns ++ &[_]BenchmarkFnc{.{ bench, decl.name ++ "." ++ pkg_decl.name }};
    //             }
    //         }
    //     }

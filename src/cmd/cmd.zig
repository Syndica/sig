...
fn validator() !void {
    ...
    const epoch_schedule = loaded_snapshot.bank.bank_fields.epoch_schedule;
    const epoch = loaded_snapshot.bank.bank_fields.epoch;
    const staked_nodes = try loaded_snapshot.bank.bank_fields.getStakedNodes(allocator, epoch);

...
const shared_transaction_status = @import("shared").ledger.transaction_status;
...
pub const TransactionTokenBalance = shared_transaction_status.TransactionTokenBalance;
pub const UiTokenAmount = shared_transaction_status.UiTokenAmount;
...
pub const TransactionError = shared_transaction_status.TransactionError;

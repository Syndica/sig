...
pub const Options = struct {
    ...
    leader_schedule: ?*const sig.core.magic_info.AggregateLeaderSchedule = null,
...
pub fn insertShreds(
    ...
    if (options.leader_schedule) |leaders| {
...
fn checkInsertDataShred(
    ...
    write_batch: *WriteBatch,
    is_trusted: bool,
    leader_schedule: ?*const sig.core.magic_info.AggregateLeaderSchedule,
    shred_source: ShredSource,
...
test "recovery" {
    ...
    const leader_schedule = sig.core.magic_info.AggregateLeaderSchedule{
        .start = min_slot,
        .leaders = leaders,
        .next_leaders = &.{},
        .next_start = max_slot + 1,
    };

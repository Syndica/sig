...
test "programSubscribe confirmed publishes on rooted without confirmed event" {
    ...
    const account_shared = try sig.runtime.accountSharedDataFromAccount(allocator, &account);
...
test "programSubscribe confirmed flushes frozen ancestors in order" {
    ...
    const account_shared1 = try sig.runtime.accountSharedDataFromAccount(allocator, &account1);
    ...
    const account_shared2 = try sig.runtime.accountSharedDataFromAccount(allocator, &account2);
    ...
    const account_shared3 = try sig.runtime.accountSharedDataFromAccount(allocator, &account3);
...
test "programSubscribe finalized flushes all newly rooted slots" {
    ...
    const account_shared10 = try sig.runtime.accountSharedDataFromAccount(allocator, &account10);
    ...
    const account_shared11 = try sig.runtime.accountSharedDataFromAccount(allocator, &account11);
...
test "programSubscribe filter dataSize applied" {
    ...
    const shared_match = try sig.runtime.accountSharedDataFromAccount(allocator, &acct_match);
    ...
    const shared_nomatch = try sig.runtime.accountSharedDataFromAccount(allocator, &acct_nomatch);
...
test "programSubscribe tokenAccountState matches account data without token owner check" {
    ...
    defer account.deinit(allocator);
    const shared_account = try sig.runtime.accountSharedDataFromAccount(allocator, &account);
...
test "programSubscribe account with non-matching owner does not publish" {
    ...
    const acct_shared = try sig.runtime.accountSharedDataFromAccount(allocator, &acct);

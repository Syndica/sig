...
pub fn parseAddressLookupTable(
    ...
    const addresses = allocator.alloc(Pubkey, lookup_table.addresses.len) catch
...
pub const UiLookupTable = struct {
    deactivationSlot: account_decoder.Stringified(u64),
    lastExtendedSlot: account_decoder.Stringified(u64),
...
test "rpc.account_decoder.parse_account_lookup_table: parse lookup tables" {

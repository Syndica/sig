...
pub const UiVoteState = struct {
    ...
    pendingDelegatorRewards: account_decoder.Stringified(u64),
...
pub const UiEpochCredits = struct {
    epoch: u64,
    credits: account_decoder.Stringified(u64),
    previousCredits: account_decoder.Stringified(u64),
};
...
test "rpc.account_decoder.parse_vote: parse vote accounts" {

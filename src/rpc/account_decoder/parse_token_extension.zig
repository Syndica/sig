...
const Base64Encoded = account_decoder.Base64Encoded;
const JsonString = account_decoder.JsonString;
const JsonArray = account_decoder.JsonArray;
...
test "rpc.account_decoder.parse_token_extension: parseExtensions TLV iteration" {
    // Test empty data
    {
...
test "rpc.account_decoder.parse_token_extension: simple extensions" {
...
test "rpc.account_decoder.parse_token_extension: pointer extensions (64 bytes)" {
...
test "rpc.account_decoder.parse_token_extension: InterestBearingConfig" {
...
test "rpc.account_decoder.parse_token_extension: ScaledUiAmountConfig" {
    // 56 bytes
...
test "rpc.account_decoder.parse_token_extension: TransferFeeConfig" {
    // 108 bytes
...
test "rpc.account_decoder.parse_token_extension: TokenGroup and TokenGroupMember" {
    // TokenGroup (80 bytes)
    {
...
test "rpc.account_decoder.parse_token_extension: confidential extensions" {
...
test "rpc.account_decoder.parse_token_extension: extractFromMint helpers" {
    const MINT_LEN = 82;
...
test "rpc.account_decoder.parse_token_extension: UiExtension jsonStringify" {

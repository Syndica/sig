...
pub const ParsableProgram = enum {
    ...
    pub const PARSABLE_PROGRAMS: [9]struct { Pubkey, ParsableProgram } = .{
        ...
        .{
            Pubkey.parse("ATokenGPvbdGVxr1b2hvZbsiqW5xWH25efTNsLJA8knL"),
            .splAssociatedTokenAccount,
        },
    ...
    pub fn fromID(program_id: Pubkey) ?ParsableProgram {
        ...
        if (program_id.equals(&Pubkey.parse("ATokenGPvbdGVxr1b2hvZbsiqW5xWH25efTNsLJA8knL"))) {
...
pub const ParsedInstructionV2 = struct {

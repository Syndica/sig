...
pub const TurbineTree = struct {
    ...
    weighted_shuffle: sig.random.weighted_shuffle.SamplerTree(.shift),
    ...
    pub fn initForRetransmit(
        ...
        return .{
            ...
            .nodes = nodes,
            .index = index,
            // does an extra refill(), but shouldn't matter too much
            .weighted_shuffle = .init(node_stakes.len, @splat(0)),

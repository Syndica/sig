...
pub const IDS = struct {
    pub const clock = Pubkey.fromBase58String("SysvarC1ock11111111111111111111111111111111") catch unreachable;
    pub const epoch_schedule = Pubkey.fromBase58String("SysvarEpochSchedu1e111111111111111111111111") catch unreachable;
    pub const epoch_rewards = Pubkey.fromBase58String("SysvarEpochRewards1111111111111111111111111") catch unreachable;
    pub const rent = Pubkey.fromBase58String("SysvarRent111111111111111111111111111111111") catch unreachable;
    pub const slot_hashes = Pubkey.fromBase58String("SysvarS1otHashes111111111111111111111111111") catch unreachable;
    pub const slot_history = Pubkey.fromBase58String("SysvarS1otHistory11111111111111111111111111") catch unreachable;
    pub const stake_history = Pubkey.fromBase58String("SysvarStakeHistory1111111111111111111111111") catch unreachable;
    pub const last_restart_slot = Pubkey.fromBase58String("SysvarLastRestartS1ot1111111111111111111111") catch unreachable;
};

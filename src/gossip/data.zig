...
test "gossip.data: contact info bincode serialize matches rust bincode" {
    ...
    var sig_contact_info = ContactInfo{
        .pubkey = Pubkey.fromBase58String("4NftWecdfGcYZMJahnAAX5Cw1PLGLZhYFB19wL6AkXqW") catch unreachable,
        .wallclock = 1721060646885,
        .outset = 1721060141617172,
        .shred_version = 0,
...
test "gossip.data: test RestartHeaviestFork serialization matches rust" {
    ...
    const x = RestartHeaviestFork{
        .from = try Pubkey.fromBase58String("6ZsiX6YcwEa93yWtVwGRiK8Ceoxq2VieVh2pvEiUtpCW"),
        .wallclock = 19,
        .last_slot = 12,
        .observed_stake = 11,
        .shred_version = 20,

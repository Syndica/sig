...
pub fn SortedMapCustom(
    ...
    return struct {
        ...
        fn bincodeDeserialize(
            ...
            const unmanaged = try sig.bincode.deserializeAlloc(allocator, Unmanaged, reader, params);
            return .{
                .allocator = allocator,
                .unmanaged = unmanaged,
            };
...
test "SortedSet bincode round trip does not break sorting" {
    ...
    var des = try sig.bincode.deserializeSlice(std.testing.allocator, SortedSet(u8), ser, .{});
    defer des.deinit();

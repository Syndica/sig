...
pub const PropagatedStats = struct {
    ...
    pub fn addNodePubkey(
        ...
        const epoch_vote_accounts = &epoch_consts.stakes.stakes.vote_accounts.accounts;
...
test "addNodePubkeyInternal" {
    ...
    var epoch_vote_accounts: sig.core.stake.StakeAndVoteAccountsMap = .empty;
    ...
    for (vote_account_pubkeys1[num_vote_accounts - staked_vote_accounts ..]) |pubkey| {
        ...
        epoch_vote_accounts.putAssumeCapacity(pubkey, .{ 1, try .initRandom(
            random,
            allocator,
            8,

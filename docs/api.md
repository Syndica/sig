...
fn main() !void {
    ...
    const pubkey = try Pubkey.fromBase58String("4rL4RCWHz3iNCdCaveD8KcHfV9YWGsqSHFPo7X2zBNwa");
...
pub fn main() !void {
    ...
    var resp = try client.getProgramAccounts(
        try Pubkey.fromBase58String("TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA"),
        .{ .filters = &filters },
    );
    defer resp.deinit();
...
pub fn main() !void {
    ...
    var resp = try client.getSignaturesForAddress(try Pubkey.fromBase58String("4rL4RCWHz3iNCdCaveD8KcHfV9YWGsqSHFPo7X2zBNwa"), .{ .limit = 10 });
    defer resp.deinit();
...
pub fn main() !void {
    ...
    var resp = try client.getStakeActivation(try Pubkey.fromBase58String(
...
pub fn main() !void {
    ...
    var pubkey = try Pubkey.fromBase58String(
...
pub fn main() !void {
    ...
    var programPubkey = try Pubkey.fromBase58String(
...
pub fn main() !void {
    ...
    var mintPubkey = try Pubkey.fromBase58String(
...
pub fn main() !void {
    ...
    var votePubkey = try Pubkey.fromBase58String(

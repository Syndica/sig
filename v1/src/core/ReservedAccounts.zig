...
const ACCOUNTS = [_]struct { pubkey: Pubkey, feature: ?Feature }{
    // zig fmt: off
    .{ .pubkey = sig.runtime.program.address_lookup_table.ID,  .feature = null },
    ...
    .{ .pubkey = sig.runtime.program.bpf_loader.v4.ID,         .feature = null },
    .{ .pubkey = sig.runtime.program.compute_budget.ID,        .feature = null },
    ...
    .{ .pubkey = sig.runtime.program.zk_elgamal.ID,            .feature = null },
    .{ .pubkey = sig.runtime.ids.ZK_TOKEN_PROOF_PROGRAM_ID,    .feature = null },

    .{ .pubkey = sig.runtime.sysvar.OWNER_ID,                  .feature = null },
    .{ .pubkey = sig.runtime.sysvar.Clock.ID,                  .feature = null },
    .{ .pubkey = sig.runtime.sysvar.EpochRewards.ID,           .feature = null },
    ...
    .{ .pubkey = sig.runtime.sysvar.LastRestartSlot.ID,        .feature = null },

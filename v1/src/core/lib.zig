...
pub const epoch_schedule = shared.v2.epoch_schedule;
pub const epoch_stakes = @import("epoch_stakes.zig");
pub const features = shared.v2.features;
...
pub const pubkey = shared.v2.pubkey;
...
pub const signature = shared.v2.signature;
...
pub const EpochSchedule = shared.v2.EpochSchedule;
...
pub const FeatureSet = shared.v2.FeatureSet;
...
pub const RentCollector = shared.core.RentCollector;
...
pub const Epoch = shared.v2.Epoch;
pub const Slot = shared.v2.Slot;
